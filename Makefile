# ====================================================================================
# Setup Project
PROJECT_NAME := provider-kafkaconnect
...
XPKGS = provider-kafkaconnect
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-kafkaconnect: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider KafkaConnect CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider KafkaConnect controllers
...
# This target prepares repo for your provider by replacing all "kafkaconnect"
